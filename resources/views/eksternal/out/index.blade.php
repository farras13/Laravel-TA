...
@section('content')
    <div class="container-fluid">
        ...
        <ol class="breadcrumb mb-4">
            ...
            <li class="breadcrumb-item active"><a href="{{ url('eksternal/out') }}">Data Keluar</a></li>
        </ol>
        <div class="card mb-4">
            <div class="card-header">
                <a class="btn btn-success float-right" href="{{ url('eksternal/out/tambah') }}">Tambah</a>
            </div>
            <div class="card-body">
                            ...
                            @foreach($data as $d)
                                ...
                                @if ($d->status == "Keluar")
                                    <tr>
                                        ...
                                        <td>{{ $d->user['name'] }}</td>
                                        <td>
                                            <a href="{{ url('eksternal/out/detail', [$d->id]) }}">Detail</a>
                                            <a href="{{ url('eksternal/out/edit', [$d->id]) }}">Edit</a>
                                            {{-- <a href="{{ url('eksternal/out/destroy', [$d->id]) }}">hapus</a> --}}
                                        </td>
                                    </tr>
                                @endif
                                <?php $n++; ?>
