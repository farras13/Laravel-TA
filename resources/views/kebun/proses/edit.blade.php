...
<div class="container-fluid">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ url('kebun/proses/update', [$data->id_pk]) }}" class="form-row" method="post">
                @csrf
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="date" name="tgl" id="tgl" class="form-control" value="{{ $data->tanggal }}" readonly>
                </div>
                <div class="col-md-12 mb-3">
                ...
                <a href="{{ route('proses') }}" class="btn btn-danger btn-block mb-2">Cancel</a>
              </form>
        </div>
    </div>
</div>
