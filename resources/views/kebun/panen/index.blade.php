    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <a class="btn btn-success float-right" href="{{ url('kebun/panen/tambah') }}">Tambah</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            @foreach($data as $d)
                                <tr>
                                    ...
                                    <td>{{ $d->user['name'] }}</td>
                                    <td>
                                        <a href="{{ url('kebun/panen/edit', [$d->id_pb]) }}">Edit</a>
                                        <a href="{{ url('kebun/panen/destroy', [$d->id_pb]) }}">hapus</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
