...
class GudangController extends Controller
{
    ...
    {
        $gen = Gen::all();
        return view('internal.create', compact('gen'));
    }
    ...
    {
        $gen = Gen::all();
        return view('eksternal.in.create', compact('gen'));
    }
    ...
    {
        $data = Tanaman::all();
        return view('eksternal.out.create', compact('data'));
    }
